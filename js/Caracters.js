...
card1.addEventListener("click", (e) => {
  ...
  imagemCard.setAttribute("src", "img/Vira-lata.jpg");
...
card2.addEventListener("click", (e) => {
  ...
  imagemCard.setAttribute("src", "img/shitzu.jpg");
  footer.appendChild(imagemCard);
});
...
card3.addEventListener("click", (e) => {
  ...
  imagemCard.setAttribute("src", "img/poodle.jpg");// Foi
  footer.appendChild(imagemCard);
});
...
card4.addEventListener("click", (e) => {
  ...
  imagemCard.setAttribute("src", "img/lhasa.jpg");
  footer.appendChild(imagemCard);
});
...
card5.addEventListener("click", (e) => {
  ...
  imagemCard.setAttribute("src", "img/buldoguefrances.jpg");
  footer.appendChild(imagemCard);
});